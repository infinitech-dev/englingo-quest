      ...
      <main className="pt-16">
        <section className="page-container pt-16">
          <div className="text-center mb-16 animate-slide-down">
            <h1 className="section-title">Explore Our Lessons</h1>
          ...
          <div className="flex justify-center space-x-4 mb-12 animate-fade-in">
            <button 
              ...
              className={`px-4 py-2 rounded-full transition-all ${filter === "all" ? "bg-primary text-white" : "bg-secondary text-foreground"}`}
            >
              All Levels
            </button>
            <button 
              onClick={() => setFilter("beginner")}
              className={`px-4 py-2 rounded-full transition-all ${filter === "beginner" ? "bg-primary text-white" : "bg-secondary text-foreground"}`}
            >
              Beginner
            </button>
            <button 
              onClick={() => setFilter("intermediate")}
              className={`px-4 py-2 rounded-full transition-all ${filter === "intermediate" ? "bg-primary text-white" : "bg-secondary text-foreground"}`}
            >
              Intermediate
            </button>
            <button 
              onClick={() => setFilter("advanced")}
              className={`px-4 py-2 rounded-full transition-all ${filter === "advanced" ? "bg-primary text-white" : "bg-secondary text-foreground"}`}
            >
              Advanced
            </button>
          </div>
